<div class="">
    ...
    <div class="mb-5">
        ...
        <h1 class="titulo-seccion text-3xl font-thin text-gray-500 mb-3">Archivo</h1>
            ...
            <table class="rounded-lg w-full">
                ...
                <thead class="border-b border-gray-300 bg-gray-50">
                    ...
                    <tr class="text-xs font-medium text-gray-500 uppercase text-left traling-wider">
                        ...
                        <th wire:click="order('tarjeta')" class="cursor-pointer px-3 py-3 hidden lg:table-cell">
            ...
            <div class="flex flex-col md:flex-row justify-between md:space-x-3 mb-5">
                ...
                <div class="flex-auto">
                    ...
                    <div>
                        ...
                        <input type="number" class="bg-white rounded text-sm w-full" wire:model.defer="folio">
                ...
                <div class="flex-auto">
                    ...
                    <div>
                        ...
                        <select class="bg-white rounded text-sm w-full" wire:model.defer="tarjeta">

                            <option value="" selected>Seleccione una opción</option>
                            <option value="1">Tiene Tarjeta</option>
                            <option value="0">No Tiene Tarjeta</option>
                    ...
                    <div>
                        ...
                        @error('tarjeta') <span class="error text-sm text-red-500">{{ $message }}</span> @enderror
            ...
            <div class="flex flex-col md:flex-row justify-between md:space-x-3 mb-5">
                ...
                <div class="flex-auto mr-1 ">
                    ...
                    <div>
                        ...
                        <input type="number" class="bg-white rounded text-sm w-full" readonly wire:model.defer="oficina">
