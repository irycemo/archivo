<div>
    ...
    @if ($verArchivos)
        ...
        @livewire('admin.reportes.catastro.reporte-archivo', ['fecha1' => $this->fecha1, 'fecha2' => $this->fecha2 ])

    @endif

    @if ($verIncidencias)

        @livewire('admin.reportes.catastro.reporte-incidencia', ['fecha1' => $this->fecha1, 'fecha2' => $this->fecha2])

    @endif

    @if ($verDigitalizacion)

        @livewire('admin.reportes.catastro.reporte-digitalizacion', ['fecha1' => $this->fecha1, 'fecha2' => $this->fecha2])
