                    ...
                    @foreach($solicitudes as $solicitudd)
                        ...
                        <tr class="text-sm font-medium text-gray-500 bg-white flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                {{ $solicitudd->archivos_catastro_solicitados_count }}
            ...
            <div class="flex flex-col md:flex-row justify-between md:space-x-3 mb-5">
                ...
                <div class="flex-auto ">
                    ...
                    <div>
                        ...
                        <input type="text" class="bg-white rounded text-sm w-full" value="101" readonly>
                ...
                <div class="flex flex-col md:flex-row justify-between md:space-x-3 mb-5">
                    ...
                    <div class="flex-auto ">
                        ...
                        <div>
                            ...
                            <input type="text" class="bg-white rounded text-sm w-full" value="{{ $archivo->localidad }}" readonly>
                    ...
                    <div class="flex-auto ">
                        ...
                        <div>
                            ...
                            <input type="text" class="bg-white rounded text-sm w-full" value="{{ $archivo->oficina }}" readonly>
                    ...
                    <div class="flex-auto ">
                        ...
                        <div>
                            ...
                            <input type="text" class="bg-white rounded text-sm w-full" value="{{ $archivo->tipo }}" readonly>
                    ...
                    <div class="flex-auto ">
                        ...
                        <div>
                            ...
                            <input type="text" class="bg-white rounded text-sm w-full" value="{{ $archivo->registro }}" readonly>
                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="rounded-lg shadow-xl w-full overflow-hidden table-auto  xl:table-fixed">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            @forEach($solicitud->archivosCatastroSolicitados as $item)

                                    <tr class="text-sm text-gray-500 bg-white">
                                        <td class="px-2 py-3 w-full text-gray-800 text-sm reak-normal">
                                            {{ $item->archivo->tomo ? $item->archivo->tomo . ' /' : ''}} {{ $item->archivo->localidad }}-{{ $item->archivo->oficina }}-{{ $item->archivo->tipo }}-{{ $item->archivo->registro }}
