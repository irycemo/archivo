<div>
    ...
    <div class="md:flex flex-col md:flex-row justify-between md:space-x-3 items-center bg-white rounded-xl mb-5 p-4">
        ...
        <div class="flex-auto ">
            ...
            <div>
                ...
                <select class="rounded text-sm w-full" wire:model="incidenciaTipo">

                    <option value="" selected>Seleccione una opción</option>

                    @foreach ($tipos as $incidencia)
    ...
    @if(count($incidencias))
        ...
        <div class="rounded-lg shadow-xl mb-5 p-4 font-thin md:flex items-center justify-between bg-white">
            ...
            <button wire:loading.attr="disabled" wire:click="descargarExcel('incidencias')" class="text-white flex items-center border rounded-full px-4 py-2 bg-green-500 hover:bg-green-700 mt-2 md:mt-0 w-full md:w-auto justify-center">
                    ...
                    @foreach($incidencias as $incidencia)
                        ...
                        <tr class="text-sm font-medium text-gray-500 bg-white flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0 text-center">
                            ...
                            <td class="w-full lg:w-auto p-3 text-gray-800 text-center lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($incidencia->creado_por != null)

                                    <span class="font-semibold">Registrado por: {{$incidencia->creadoPor->name}}</span> <br>
                            ...
                            <td class="w-full lg:w-auto p-3 text-gray-800 text-center lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($incidencia->actualizado_por != null)

                                    <span class="font-semibold">Actualizado por: {{$incidencia->actualizadoPor->name}}</span> <br>
